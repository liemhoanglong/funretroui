...
import { Row, Card, CardGroup, Button } from 'react-bootstrap'
  ...
  return (
    <>
      { props.type === "1" ? (props.data.type.toString() === props.type ?
        <Row className="row" key={props.data._id} style={{ paddingBottom: "15px" }} >
        ...
        : props.type === "2" ? (props.data.type.toString() === props.type ?
          <Row className="row" style={{ paddingBottom: "15px" }} >
            { props.edit && props.data._id !== props.edit.id ? 
              <Card style={{ width: "100%", border: "none" }}>
